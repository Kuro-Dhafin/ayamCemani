...
public class BossNew : MonoBehaviour
{
    ...
    private IEnumerator SpawnEnemies()
    {
        ...
        animator.SetBool("IsSummon", true);  // Memulai animasi summon

        // Tunggu animasi summon selesai
        yield return new WaitForSeconds(1.0f);  // Asumsi durasi animasi adalah 1 detik

        // Spawn enemies setelah animasi selesai
